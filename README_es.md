...
### Instalacion rapida (Linux/macOS, recomendado)
...
```bash
rtk --version   # Debe mostrar "rtk 0.34.x-algolia.y"
...
Las contribuciones son bienvenidas. Abre un issue o PR en [GitHub](https://github.com/algolia/rtk).
